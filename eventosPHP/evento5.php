      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-sm-6">
            <br>
            <br>
            <img class="img-fluid eventos altura-a-b" src="../images/home/banner4.jpg" alt="Pantalla">
          ...
          <div class="col-12 col-sm-6 altura-a-b">
            ...
            <h1>LA ETNNIA</h1>
            <br>
            <h5>Lugar: Media Torta</h5>
            <h5>Ciudad: Medellin</h5>
            <h5>Fecha: 10 de Mayo de 2022</h5>
            <h5>Hora: 4PM</h5>

            <br>
            <p>Hecho en Colombia es un reflejo de aquellos sonidos que se han venido modernizando y tienen como base la música colombiana. Estas nuevas propuestas musicales vienen de las diferentes regiones del país apostando a una modernización y caracterización de  los sonidos colombianos. 
               Es por ello que los grandes exponentes del género como lo son La Etnnia y la nueva generación del Hip Hop Colombiano Realidad Mental.
            </p>
            <br>
            <h5>Dinamica del evento:</h5>
            <p>*La hora de inicio es desde las 4PM.</p>
            <p>*La apertura de las puertas es desde las 2PM.</p>
