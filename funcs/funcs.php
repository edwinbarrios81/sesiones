<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Host = 'smtp-mail.outlook.com'; //Modificar
		$mail->Port = '587'; //Modificar
		
		$mail->Username = 'edwinbarrios81@hotmail.com'; //Modificar
		$mail->Password = 'Policia123'; //Modificar
		
		$mail->setFrom('edwinbarrios81@hotmail.com', 'Edwin Mauricio Barrios Almeida'); //Modificar
